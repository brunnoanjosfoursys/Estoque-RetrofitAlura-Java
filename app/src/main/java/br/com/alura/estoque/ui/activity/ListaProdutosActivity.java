...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    private static final String MENSAGEM_ERRO_BUSCA_PRODUTOS = "Não foi possível carregar os " +
            "produtos novos";
    ...
    static final String MENSAGEM_ERRO_EDICAO = "Não foi possível editar o produto";
    ...
    private void abreFormularioSalvaProduto() {
        new SalvaProdutoDialog(this, this::salva).mostra(); //Consigo fazer method reference pois
        // recebo via listener do nosso Dialog
    }
